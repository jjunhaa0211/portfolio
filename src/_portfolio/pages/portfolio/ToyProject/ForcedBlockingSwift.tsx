...
const ForcedBlockingSwift = () => {
  ...
  **FamilyControls** 기능을 활용하여 **앱을 차단**하는 작업을 개발하면서 큰 성취감을 느꼈습니다. 기존에는 시간제한을 두어 앱 사용을 제어했지만, 이번에 기능은 제가 릴스와 유튜브 중독을 벗어나기 위해 만드는 프로젝트 이기 때문에 1분 더 보기, 15분 더 보기와 같은 기능을 추가하지 않아서 차단된 앱은 사용자가 차단을 해제하기 전까지는 절대 사용할 수 없게 하였습니다. 이번 프로젝트를 진행하면서 다른 앱에 접근하여 차단하는 기능을 구현한 것이 신기했습니다.
