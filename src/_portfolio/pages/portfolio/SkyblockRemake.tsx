import { H1, H2, H3, Img, Lefter, P, Tags, Top } from "../../components/layout/projectLayout";
...
const SkyblockRemake = () => {
    return <>
        ...
        <P>- 수집 도전과제: 일정량 아이템을 수집할 경우 해당 아이템의 수집도가 증가하고 커스텀 레시피가 활성화 됨</P>
        <Lefter>
        ...
        <H3>📚 회고</H3>
        <P>- 마인크래프트는 싱글 스레드 게임이기 때문에 최적화에 신경을 써가며 코드를 작성하게 되었다.</P>
