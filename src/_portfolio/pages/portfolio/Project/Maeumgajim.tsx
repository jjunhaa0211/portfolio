...
const Maeumgajim = () => {
  ...
  ### 현재의 마음가짐
  마음가짐은 오는 9월 초에 배포될 예정입니다. 이미 TestFlight를 통해 **배포 준비가 완료**되었고, 현재는 xcodeCloud에도 업로드된 상태입니다. 처음에 14명으로 시작한 마음가짐 프로젝트는 이제 3기를 맞이하여 20명의 개발자들과 함께 개발을 진행하고 있습니다. 이 프로젝트에는 **데브옵스 2명**, **iOS 개발자 5명**, **백엔드 개발자 4명**, **플러터 개발자 3명**, **프론트엔드 개발자 6명**이 참여하고 있어 대규모 프로젝트로 성장했습니다.
  ...
  return (
    <>
      ...
      <P>
        ...
        감소 문제를 해결하는 것이 마음가짐의 목적입니다. 9월초 1차 배포를 앞두고
        있습니다.
      </P>
