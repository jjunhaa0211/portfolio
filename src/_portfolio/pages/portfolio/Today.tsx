...
\`해결 방법\`
  ...
  또한 프로젝트를 통해 카메라 앱을 개발하면서, 시뮬레이터에서 구현할 수 없는 기능들을 직접 학습하며 경험을 쌓는 시간을 가질 수 있었습니다.
  그리고 저희는 이벤트 부스인 만큼 사용자가 많이 몰릴 것을 고려하였습니다. 그리고 사용자와 기업의 피드백을 받으면서 단시간내에 기능을 추가하는 작업등을 구현과 프레임 추가 등등 사용자들이 원하는 기능과 니즈의 파악의 중요성을 깨닫게 되었습니다.  
