...
const Lite24 = () => {
    return <>
        <Top>
            ...
            <Txt typography={"H0"}>Lite24 <Txt typography={"P1"}>22.04.29~22.05.30</Txt></Txt>
        </Top>
        <Tags>{["spigot", "java", "sql", "sqlite"].map(v => DefaultTag[v as keyOfDefaultTag])}</Tags>

        <URLBox>
            <URLItem icon={"Cafe"} url={"https://cafe.naver.com/lite24"}>
                <Txt>Cafe</Txt>
            </URLItem>
            <URLItem icon={"Github"} url={"https://github.com/Mooner510/BungeeAPI"}>
                <Txt>Github (BungeeAPI)</Txt>
            </URLItem>
            <URLItem icon={"Github"} url={"https://github.com/Mooner510/LiteBungeeChat"}>
                <Txt>Github (LiteBungeeChat)</Txt>
            </URLItem>
            <URLItem icon={"Github"} url={"https://github.com/Mooner510/LiteJoin"}>
                <Txt>Github (LiteJoin)</Txt>
            </URLItem>
            <URLItem icon={"Github"} url={"https://github.com/Mooner510/MoonerEco"}>
                <Txt>Github (MoonerEco)</Txt>
            </URLItem>
            <URLItem icon={"Github"} url={"https://github.com/Mooner510/MoonerSethome"}>
                <Txt>Github (MoonerSethome)</Txt>
            </URLItem>
            <URLItem icon={"Github"} url={"https://github.com/Mooner510/InventoryShare"}>
                <Txt>Github (InventoryShare)</Txt>
            </URLItem>
            <URLItem icon={"Github"} url={"https://github.com/Mooner510/Lands"}>
                <Txt>Github (Lands)</Txt>
            </URLItem>
        </URLBox>

        <H3>📖 요약</H3>
        <P>마인크래프트 서버 Lite24(LiteNetworks)를 직접 운영하고 유지보수 한 프로젝트</P>
